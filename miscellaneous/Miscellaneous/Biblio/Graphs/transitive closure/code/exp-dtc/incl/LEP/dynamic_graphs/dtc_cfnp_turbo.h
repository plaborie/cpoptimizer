//-----------------------------------------------------
// dtc_cfnp_turbo.h : header of the dtc_cfnp_turbo class which 
// implements the optimized version of the Dynamic Transitive Closure
// algorithm (CFNP-Opt) by Cicerone,Frigioni,Nanni and Pugliese 
// on directed graphs.
//
// Giulio Pasqualone 1997; 
// modified by D. Frigioni & C. Zaroliagis 1998
//-----------------------------------------------------


#ifndef _DTC_CFNP_TURBO_H
#define _DTC_CFNP_TURBO_H 
...
#endif _DYN_NODE_MATRIX
//----------------------------------------------------------------------------

/*{\Manpage {dtc_cfnp_turbo} {} {Dynamic maintenance of the Transitive Closure of a digraph based on Cicerone, Frigioni, Nanni and Pugliese's 
algorithm} {DTC}}*/

class dtc_cfnp_turbo : public dga_base
{ 
/*{\Mdefinition
...
does not check whether the graph is acyclic or not. 
 ...
 bool updated; //flag indicating if data structures are updated
...
//following 2 methods specialized for monotonic series of edge operations
 void tc_edge_insertion_turbo(node,node);
 void tc_edge_deletion_turbo(node,node);
/////////////////////////////////////////////////////////////////////////
...
/*{\Mcreation}*/     
 ...
 dtc_cfnp_turbo(msg_graph* G) : dga_base(G) { initialize_new_g(*G); }
/*{\Mcreate}*/
...
/*{\Moptions warnings=no}*/
  ...
  void insert_edge(edge e,double weight=1.0)
                    { tc_edge_insertion_turbo(MGP->source(e),MGP->target(e));
                    }
...
/*{\Mop deletes the edge |e| from |\Mvar|.}*/
  ...
  void after_edge_removal(node v,node w) { tc_edge_deletion_turbo(v,w); }
...
\headerline{Description Operations}
  ...
  string name() const { return string("Cicerone, Frigioni, Nanni and Pugliese ")
                               + string("Dynamic Transitive Closure");
                      }
...
from.}*/
  ...
  string description() const 
                     { return 
                           string("The data structure dtc_cfnp_turbo implements the ")
...
/*{\Mop returns the current version of the class.}*/
  ...
  string authors() const { return string("G. Pasqualone, D. Frigioni, and C. Zaroliagis"); }
/*{\Mop returns the name of the authors of the implementation.}*/

  string timestamp() const { return string("30 January 1998"); }
/*{\Mop returns the date of the current implementation.}*/

   };
#endif _DTC_CFNP_TURBO_H
