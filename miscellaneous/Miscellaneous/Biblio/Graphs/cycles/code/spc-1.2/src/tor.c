...
long   cm = 1,             /* lower bound of the interval */
...
/* printing title */
printf ("c\nc tor network for shortest paths problem\n\
...
fprintf ( stderr, 
"\n'%s' - tor network generator for shortest paths problem\n\
with negative cycles.\n\
\n\
...
-cm#i - #i is the lower bound on layer arc lengths    (default 1)\n\
...
-cm#i - #i is the lower bound on arc lengths          (default 1)\n\
-c#t  - #t is the type of connecting graph: { c | d | p }\n\
           c - cycle, d - double cycle, p - path      (default d)\n\
\n\
