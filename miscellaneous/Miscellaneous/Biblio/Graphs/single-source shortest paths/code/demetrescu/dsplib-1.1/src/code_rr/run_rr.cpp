...
// Change log:      CD000430
// Description:     class_rr algorithm driver
...
int main(int argc, char *argv[]){
    ...
    // Build class_rr instance
    class_rr SP(theGraph, theNegCycleFound, theSource);
    ...
    for (int i=0; i<theNumOp; i++) {
        ...
        if ( SP.ChangeWeight(theNodeXId, theNodeYId, theNewWeight ) != class_rr::_OK ) {
