        ...
        switch (c[0]) {
            ...
            case 'l': {
                ...
                switch (theGraph.read(theFileName)) {
                    ...
                    default:
                        ...
                        theSP = new class_rr(theGraph, theNegCycleFound);
            ...
            case 'c': {
                ...
                switch (theSP->ChangeWeight(theX,theY,theW)) {
                    case class_rr::_OK:             puts("OK");                                           break;
                    case class_rr::_InvalidEdge:    puts("Invalid edge");                                 break;
                    case class_rr::_NegativeCycle:  puts("Negative cycle"); delete theSP; theSP = nil;    break;
                }
                break;
            }
            ...
            case 'r': {
                ...
                for (int i=1; i<=theNumOp && i<=theMaxNumOp; i++) {
                    ...
                    if ( theSP->ChangeWeight(theNodeXId, theNodeYId, theNewWeight ) != class_rr::_OK ) {
