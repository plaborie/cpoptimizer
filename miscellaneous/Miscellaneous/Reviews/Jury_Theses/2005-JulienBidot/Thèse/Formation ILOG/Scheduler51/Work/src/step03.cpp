...
//
//
// Step 3: Unary Resource with initial occupation
//
// initial occupation of the resource:
//  the worker does not work the 2 first weekends
//  and cannot interrupt a task (disjunctive break)
//
///////////////////////////////////////////////////////////////////////////////
                   ...
                   IloArray<IloActivity>& arrayActivities)
{
  ...
  IloActivity masonry   (env, 5, "masonry   ");
  IloActivity carpentry (env, 3, "carpentry ");
  IloActivity plumbing  (env, 5, "plumbing  ");
  ...
  // initial occupation
  /********* to be filled in ... *********/
  IloNumToNumStepFunction occupation(env,0,50,0);
  IloNumToNumStepFunction free(env,0,7,0);
  free.addValue(5,7,1);
  occupation.setPeriodic(free,0,10);
  worker.setInitialOccupationParam(occupation);
