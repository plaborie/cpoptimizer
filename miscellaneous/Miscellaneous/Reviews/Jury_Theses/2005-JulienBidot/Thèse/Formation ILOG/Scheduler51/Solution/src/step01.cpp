...
///////////////////////////////////////////////////////////////////////////////
//
// Solution of Step 1: Activities (cpert)
//
...
int main()
{
  ...
  // (cf header) whe don't want to completely solve the problem,
  ...
  solver.solve(IloInstantiate(env,makespan));

  // editions : two ways are possible :
