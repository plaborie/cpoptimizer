...
///////////////////////////////////////////////////////////////////////////////
//
// Step 2a: Discrete Resources
//
// Introducing two equivalent workers who build the house.
//
///////////////////////////////////////////////////////////////////////////////
			  ...
			  IloArray<IloActivity>& arrayActivities)
{
  ...
  // create the Resource ...
  /********* to be filled in ... *********/
  IloDiscreteResource workers(env,2,"workers ");

  // .. and require it for each activity
  for (IloInt i = 0; i < nbActivities; i++)
  {
      /********* to be filled in ... *********/
	  model.add(arrayActivities[i].requires(workers));
