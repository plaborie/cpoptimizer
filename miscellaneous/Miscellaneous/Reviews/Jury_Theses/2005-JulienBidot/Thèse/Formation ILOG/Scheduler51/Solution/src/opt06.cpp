...
///////////////////////////////////////////////////////////////////////////////
//
// Solution of Step opt06 : Overlapping Breaks
//
//  As in step 5, the worker has breaks
//  but if needed, an activity of duration at least 2
//    can be finished on the saturday
//
///////////////////////////////////////////////////////////////////////////////
                   ...
                   IloArray<IloActivity>& arrayActivities)
{
  ...
  for (IloInt w = 0; w < nbActivities; w++) {
    ...
    if (!activity.isBreakable() &&
        activity.getProcessingTimeVariable().getMin() >= 2) {
