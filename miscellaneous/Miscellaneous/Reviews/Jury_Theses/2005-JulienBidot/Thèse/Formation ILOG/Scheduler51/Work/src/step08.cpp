...
///////////////////////////////////////////////////////////////////////////////
//
// Step 8: Setting-time goals
//
// solver.solve() may be inefficient in large problems.
// ranking goal (cf. step 7) is not complete
// so make a search goal to set activity times after the ranking
//
///////////////////////////////////////////////////////////////////////////////
...
int main()
{
	...
	// RANKING GOAL :
	IloGoal rankGoal = IloRankForward(env, worker, IloSelFirstRCMinEndMax);

	// SETTING TIME GOAL
	IloGoal setTimesGoal = IloSetTimesForward (env, IloSelFirstActMinEndMin);/********* to be filled in ... *********/

	// activating the goals,
	solver.solve(rankGoal && setTimesGoal/********* to be filled in ... *********/);//ou IloAndGoal()
