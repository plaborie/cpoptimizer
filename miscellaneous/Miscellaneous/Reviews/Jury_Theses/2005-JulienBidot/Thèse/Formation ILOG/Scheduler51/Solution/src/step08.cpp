...
///////////////////////////////////////////////////////////////////////////////
//
// Solution of Step 8 : Setting times goals
//
...
int main()
{
  ...
  IloUnaryResource worker;
	...
	// SETTING TIME GOAL
	IloGoal setTimesGoal = 
		IloSetTimesForward(env, IloSelFirstActMinEndMax);

	// active the goals,
	solver.solve(IloAndGoal(env, rankGoal,setTimesGoal));
