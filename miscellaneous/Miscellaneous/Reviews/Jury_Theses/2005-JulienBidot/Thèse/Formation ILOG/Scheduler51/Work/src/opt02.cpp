...
// Extensions object).
// Associate this this object with the IlcUnaryResource using
// a special goal.
//
//  Method #3:
//
...
//
// Change the IloTransitionCost construction (Method #1) so that transitions
...
void MakeTransitionCostMethod1(const IloEnv env,
                               ...
                               IloIntVar& cost)
{
  // CREATE THE SYMMETRIC TRANSITION PARAM
...
ILOCPGOALWRAPPER3(AddExtensions, solver,
                  ...
                  IloInt, method)
{
  // Get ILOG Scheduler Extensions objects
