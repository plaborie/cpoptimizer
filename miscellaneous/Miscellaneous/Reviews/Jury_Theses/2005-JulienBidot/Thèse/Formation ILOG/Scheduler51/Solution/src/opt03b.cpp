...
//
// Three different workers build a house (Solution)
//
///////////////////////////////////////////////////////////////////////////////
			  ...
			  IloArray<IloActivity>& arrayActivities)
{
  ...
  // step b
  model.add(IloIfThen(env, alternatives[0].select(joe),
	  alternatives[1].select(joe)));
  model.add(IloIfThen(env, alternatives[0].select(jack),
	  alternatives[1].reject(jack)));
...
/* Step b
masonry    [0 -- 7 --> 7] is executed by Joe [1]
carpentry  [7..9 -- 3 --> 10..12] is executed by Joe [1]
plumbing   [7 -- 8 --> 15] is executed by Jim [1]
ceiling    [7..10 -- 3 --> 10..13] is executed by Jack [1]
roofing    [10..12 -- 1 --> 11..13] is executed by Joe [1]
painting   [11..13 -- 2 --> 13..15] is executed by Joe [1]
windows    [13..15 -- 1 --> 14..16] is executed by Joe [1]
facade     [15 -- 2 --> 17] is executed by Jack [1]
