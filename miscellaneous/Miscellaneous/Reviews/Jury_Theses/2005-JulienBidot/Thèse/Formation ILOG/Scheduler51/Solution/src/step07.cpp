...
///////////////////////////////////////////////////////////////////////////////
//
// Solution of Step 7 : Ranking goals
//
// solver.solve() may be inefficient in big problems.
// so make a search goal to rank resource requirement constraints 
///////////////////////////////////////////////////////////////////////////////
...
int main()
{
  ...
  IloUnaryResource worker;
	...
	// RANKING GOAL :
	IloGoal rankGoal =
		IloRankForward(env, worker, IloSelFirstRCMinStartMax);

	// activating the goal,
	solver.solve(rankGoal);
...
/*
masonry    [0..65 -- (7) 7..11 --> 9..72]
carpentry  [20..81 -- 3 --> 23..84]
plumbing   [10..73 -- (8) 8..10 --> 20..81]
ceiling    [25..86 -- 3 --> 28..89]
roofing    [28..89 -- 1 --> 29..90]
painting   [31..92 -- 2 --> 33..94]
windows    [33..94 -- 1 --> 34..95]
facade     [29..90 -- 2 --> 31..92]
garden     [37..98 -- 1 --> 38..99]
moving     [38..99 -- 1 --> 39..100]
*/

// end of file step07.cpp
