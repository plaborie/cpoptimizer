                   ...
                   IloArray<IloActivity>& arrayActivities)
{
  ...
  // OVERLAPPING:
  // set other activities to overlap one day
  ...
  // assign the type to each activity
  /********* to be filled in ... *********/
  ...
  /********* to be filled in ... *********/
  IloTransitionParam transitionTable(env,3);
  transitionTable.setValue(0,1,1);
  transitionTable.setValue(1,2,2);
  transitionTable.setValue(0,2,3);



  // assign it to the resource
  /********* to be filled in ... *********/
  IloTransitionTime assign(worker,transitionTable);
