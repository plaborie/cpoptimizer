...
dvar interval moveInStart[l in Jobs] size LoadDuration;
dvar interval moveInEnd  [l in Jobs] size LoadDuration;
dvar interval moveOutStart[l in Jobs] size LoadDuration;
dvar interval moveOutEnd  [l in Jobs] size LoadDuration;
...
subject to {
  ...
  forall (a in Alternatives) {
     ...
     prev(transition[a.op], moveInOpStart[a], moveInOpEnd[a]);
     prev(transition[a.op], moveOutOpStart[a], moveOutOpEnd[a]);
   }
