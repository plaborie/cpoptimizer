...
Available at:
  http://www.cs.st-andrews.ac.uk/~apes/apesreports.html
...
public class Talent
{
    ...
    private void BuildModel()
    {
        ...
        idleCost = cp.IntVar(0, Int16.MaxValue);
        ...
        for (int a = 0; a < numActors; a++)
        {
            ...
            cost = cp.Sum(cost, cp.Prod(actorPay[a], actorWait));
        }
        cp.Add(cp.Eq(idleCost, cost));
