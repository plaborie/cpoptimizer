...
{ int } NonMandatoryTaskIds = { n.taskId | n in NonMandatoryTasks }; //  set of nonMandatory task ids
...
dvar interval task[t in Tasks]       // FILL IN 	;
...
dexpr float nonExecCost = // FILL IN;
...
subject to {   
  ...
  // NonMandatory tasks in work breakdown structure
  // FILL IN // top level task must be present
  // FILL IN // mandatory tasks must be present if their parent is present.  
