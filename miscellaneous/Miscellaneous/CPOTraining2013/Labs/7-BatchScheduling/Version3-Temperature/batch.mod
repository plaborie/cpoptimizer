...
int maxTime = sum(t in allTasks)(t.duration + preparationTime);// upper limit on scheduling horizon
...
constraints {
  ...
  // the temperatureCode on an oven should correspond to the temperatureCode of the task scheduled on the oven at any point in time
  // FILL IN  
