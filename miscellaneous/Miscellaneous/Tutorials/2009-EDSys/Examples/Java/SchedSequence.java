...
//end:MAKECOST
    ...
    static IloIntervalVar[] arrayFromList(List<IloIntervalVar> list) {
...
//$doc:SEQVAR
            IloIntervalSequenceVar joe = cp.intervalSequenceVar(arrayFromList(joeTasks), arrayFromList(joeLocations), "Joe");
            IloIntervalSequenceVar jim = cp.intervalSequenceVar(arrayFromList(jimTasks), arrayFromList(jimLocations), "Jim");
//end:SEQVAR
