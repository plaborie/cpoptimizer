...
// batches of specialty chemicals to order. Principal equipment consists of
// eight interchangable reactor vessels, five interchangeable distillation
...
// batches of one or more specialty chemicals, normally to be delivered
