...
\hypersetup{%
pdftitle={Reasoning with Conditional Time-intervals, Part II},
pdfauthor={Philippe Laborie; J\'er\^ome Rogerie; Paul Shaw; Petr Vil\'im},
pdfkeywords={},
%bookmarksnumbered,
pdfstartview={FitH},
urlcolor=cyan,
...
\begin{center} 
{\sc ILOG\ Technical report number 09-001}
...
\vspace{1.5cm}
{\large Philippe Laborie and J\'er\^ome Rogerie and Paul Shaw and Petr Vil\'im} \\
\vspace{0.7cm}
...
\begin{figure}[ht]
\centering
\includegraphics[width=7.5cm,keepaspectratio,clip]{sequence.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=10cm,keepaspectratio,clip]{shapes.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=8.5cm,keepaspectratio,clip]{solcumul.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=11cm,keepaspectratio,clip]{state.pdf}
