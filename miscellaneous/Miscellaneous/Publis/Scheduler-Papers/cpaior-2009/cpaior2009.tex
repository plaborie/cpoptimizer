...
\usepackage{url}
\urldef{\mailsa}\path|laborie@fr.ibm.com|
...
\begin{itemize}
\item A {\bf presence constraint} $\presenceOf(a)$ states that interval $a$ is present, that is $a \neq \bot$. This constraint can be composed, for instance $\presenceOf(a) \Rightarrow \presenceOf(b)$ means that the presence of $a$ implies the presence of $b$.
...
\begin{itemize}
  \item {\bf Forbidden start constraint}. Constraint $\forbidStart(a, F)$ states that whenever interval $a$ is present, it cannot start at a value $t$ where $F(t)=0$.
  \item {\bf Forbidden end constraint}. Constraint $\forbidEnd(a, F)$ states that whenever interval $a$ is present, it cannot end at a value $t$ where $F(t-1)=0$. 
  \item {\bf Forbidden extent constraint}. Constraint $\forbidExtent(a, F)$ states that whenever interval $a$ is present, it cannot overlap a point $t$ where $F(t)=0$. 
\end{itemize}
...
\begin{figure}[ht]
\centering
\includegraphics[width=11.5cm,keepaspectratio,clip]{shapes.pdf}
...
\begin{table*}
	\centering
		\begin{tabular}{|l|r|r|r|r|l|r|r|r|}\hline
		Problem & GA-best & S-LNS-best & \CPOResult{CPO} && Problem & GA-best & S-LNS-best & \CPOResult{CPO}\\ \hline
		jb1     & 0.474   & 0.191 &  \CPOResult{0.191} && ljb1    & 0.279   & 0.215 & \CPOResult{0.215} \\ \hline
		jb2     & 0.499   & 0.137 &  \CPOResult{0.137} && ljb2    & 0.598   & 0.508 & \CPOResult{0.509} \\ \hline
		jb4     & 0.619   & 0.568 &  \CPOResult{0.568} && ljb7    & 0.246   & 0.110 & \CPOResult{0.137} \\ \hline
		jb9     & 0.369   & 0.333 &  \CPOResult{0.334} && ljb9    & 0.739   & 1.015 & \CPOResult{0.744} \\ \hline
		jb11    & 0.262   & 0.213 &  \CPOResult{0.213} && ljb10   & 0.512   & 0.525 & \CPOResult{0.549} \\ \hline
		jb12    & 0.246   & 0.190 &  \CPOResult{0.190} && ljb12   & 0.399   & 0.605 & \CPOResult{0.518} \\ \hline
		\end{tabular}
  \vspace*{1mm}
...
\item All tasks are optional; the objective is to minimize the number of unassigned tasks\footnote{A second type of model with task priorities is also described in~\cite{Kramer2007}. In the present paper, we focus on the version without task priorities.}.
\end{itemize}
...
\begin{table*}
	\centering
		\begin{tabular}{|l|r|r|r|r|l|r|r|r|}\hline
		Problem set   & TS     & SWO    & \CPOResult{CPO}   & & Problem set   & TS     & SWO    & \CPOResult{CPO}   \\ \hline
	  1.1           &  30.44 &  26.60 & \CPOResult{27.50} & & 4.1           &   3.20 &   2.00 & \CPOResult{1.96}  \\ \hline
	  1.2           & 114.02 & 104.72 & \CPOResult{98.10} & & 4.2           &  13.34 &   7.90 & \CPOResult{7.48}  \\ \hline
	  1.3           &  87.92 &  84.52 & \CPOResult{86.04} & & 4.3           &  16.60 &  12.46 & \CPOResult{9.68}  \\ \hline
	  2.1           &  11.46 &   7.80 & \CPOResult{7.84}  & & 5.1           &   3.90 &   3.80 & \CPOResult{3.76}  \\ \hline
	  2.2           &  45.54 &  34.26 & \CPOResult{30.64} & & 5.2           &  32.98 &  31.98 & \CPOResult{31.72} \\ \hline
	  2.3           &  33.96 &  31.18 & \CPOResult{32.14} & & 5.3           &  46.18 &  45.22 & \CPOResult{44.34} \\ \hline
	  3.1           &   2.64 &   2.32 & \CPOResult{2.28}  & & 6.1           &   1.56 &   1.28 & \CPOResult{1.24}  \\ \hline
	  3.2           &  15.50 &  12.82 & \CPOResult{11.82} & & 6.2           &  11.62 &   9.56 & \CPOResult{8.92}  \\ \hline
	  3.3           &  32.10 &  28.58 & \CPOResult{24.00} & & 6.3           &  25.28 &  22.60 & \CPOResult{19.48} \\ \hline
		\end{tabular}
  \vspace*{1mm}
...
\begin{figure}[ht]
\centering
\includegraphics[width=8cm,keepaspectratio,clip]{preferences.pdf}
...
\begin{table*}
	\centering
		\begin{tabular}{|l|r|r|r|l|r|r|r|l|r|r|r|l|r|r|}\hline
		\#    & SWO   & \CPOResult{CPO}   && \#    & SWO   & \CPOResult{CPO}   && \#    & SWO   & \CPOResult{CPO}   && \#    & SWO   & \CPOResult{CPO} \\ \hline
		15-1  & 12.95 & \CPOResult{14.66} && 30-6  & 28.09 & \CPOResult{29.28} && 40-1  & 24.72 & \CPOResult{28.95} && 45-6  & 32.70 & \CPOResult{37.35}   \\ \hline
		15-2  & 12.25 & \CPOResult{13.16} && 30-7  & 23.80 & \CPOResult{24.20} && 40-2  & 23.48 & \CPOResult{32.07} && 45-7  & 32.40 & \CPOResult{35.77}   \\ \hline
		15-3  & 13.71 & \CPOResult{13.90} && 30-8  & 24.06 & \CPOResult{26.89} && 40-3  & 33.57 & \CPOResult{37.74} && 45-8  & 31.79 & \CPOResult{35.23}   \\ \hline
		15-4  & 11.57 & \CPOResult{12.55} && 30-9  & 23.42 & \CPOResult{24.86} && 40-4  & 31.46 & \CPOResult{35.45} && 45-9  & 35.79 & \CPOResult{38.86}   \\ \hline
		15-5  & 12.64 & \CPOResult{14.67} && 30-10 & 22.04 & \CPOResult{27.18} && 40-5  & 28.05 & \CPOResult{34.21} && 45-10 & 32.78 & \CPOResult{40.68}   \\ \hline
		15-6  & 14.30 & \CPOResult{14.63} && 35-1  & 28.80 & \CPOResult{31.56} && 40-6  & 29.46 & \CPOResult{34.01} && 50-1  & 42.04 & \CPOResult{43.53}   \\ \hline
		15-7  & 13.08 & \CPOResult{14.46} && 35-2  & 29.17 & \CPOResult{32.33} && 40-7  & 33.13 & \CPOResult{37.51} && 50-2  & $\times$ & \CPOResult{$\times$}   \\ \hline
		15-8  & 11.46 & \CPOResult{12.37} && 35-3  & 27.84 & \CPOResult{28.58} && 40-8  & 29.72 & \CPOResult{34.90} && 50-3  & $\times$ & \CPOResult{37.17}   \\ \hline
		15-9  & 11.44 & \CPOResult{11.61} && 35-4  & 26.64 & \CPOResult{29.67} && 40-9  & 33.03 & \CPOResult{36.89} && 50-4  & $\times$ & \CPOResult{36.52}   \\ \hline
		15-10 & 12.07 & \CPOResult{13.51} && 35-5  & 25.15 & \CPOResult{32.13} && 40-10 & 30.28 & \CPOResult{34.19} && 50-5  & 34.25 & \CPOResult{43.55}   \\ \hline
		30-1  & 24.17 & \CPOResult{29.13} && 35-6  & 26.12 & \CPOResult{29.49} && 45-1  & 37.42 & \CPOResult{42.90} && 50-6  & 38.32 & \CPOResult{41.87}   \\ \hline
		30-2  & 24.69 & \CPOResult{27.55} && 35-7  & 29.28 & \CPOResult{31.69} && 45-2  & 33.97 & \CPOResult{39.71} && 50-7  & 32.59 & \CPOResult{42.48}   \\ \hline
		30-3  & 25.61 & \CPOResult{26.53} && 35-8  & 25.71 & \CPOResult{30.07} && 45-3  & 35.44 & \CPOResult{39.40} && 50-8  & 34.70 & \CPOResult{43.67}   \\ \hline
		30-4  & 27.13 & \CPOResult{28.49} && 35-9  & 23.74 & \CPOResult{29.60} && 45-4  & 33.02 & \CPOResult{37.41} && 50-9  & $\times$ & \CPOResult{42.75}   \\ \hline
		30-5  & 23.89 & \CPOResult{26.46} && 35-10 & 30.70 & \CPOResult{33.41} && 45-5  & 30.83 & \CPOResult{36.65} && 50-10 & 37.46 & \CPOResult{41.84}   \\ \hline \hline
		55-1  & $\times$ & \CPOResult{36.84}    && 55-4  & $\times$ & \CPOResult{40.36} && 55-7  & $\times$ & \CPOResult{$\times$} && 55-10 & \CPOResult{$\times$} & \CPOResult{$\times$}   \\ \hline
		55-2  & $\times$ & \CPOResult{38.56}    && 55-5  & $\times$ & \CPOResult{42.70} && 55-8  & $\times$ & \CPOResult{45.27} &&       &&    \\ \hline
		55-3  & $\times$ & \CPOResult{$\times$} && 55-6  & $\times$ & \CPOResult{35.92} && 55-9  & $\times$ & \CPOResult{42.14} &&       &&    \\ \hline
		\end{tabular}
  \vspace*{1mm}
