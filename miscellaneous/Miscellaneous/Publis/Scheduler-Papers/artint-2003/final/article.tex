...
\title{Algorithms for Propagating Resource Constraints
       in A.I. Planning and Scheduling: Existing Approaches and New Results\thanksref{ecp}}

\thanks[ecp]{A shorter version of this paper appeared in {\em
Proceedings of the Sixth European Conference on Planning},
Toledo, Spain, 2001.}

\author{Philippe Laborie}

\address{ILOG S.A., 9, rue de Verdun, BP 85\\
	F-94253 Gentilly Cedex, France\\
	plaborie@ilog.fr}


\begin{abstract} 
This paper summarizes   the main   existing approaches  to   propagate
...
\begin{keyword}
Scheduling \sep AI Planning \sep Constraint Programming \sep
...
\begin{figure}
\centerline{\includegraphics[width=30pc]{figures/fig3.eps}}
...
\begin{figure}
\centerline{\includegraphics[width=20pc]{figures/fig1.eps}}
...
\begin{figure}
\centerline{\includegraphics[width=28pc]{figures/fig2.eps}}
...
\vspace*{-7.5mm}
\begin{tabular}{lll}
\vspace*{-2.5mm}$<A_1,R,-2,FromStartToEnd>$, &$<A_2,R,[-10,-5],AfterStart>$,\\
\vspace*{-2.5mm}$<A_3,R,-1,AfterStart>$,     &$<A_4,R,           +4,AfterEnd>$,\\
\vspace*{-2.5mm}$<A_5,R,+2,AfterEnd>$,       &$<A_6,R,+2,AfterEnd>$
\end{tabular}
...
\begin{figure}
\centerline{\includegraphics[width=20pc]{figures/fig4.eps}}
...
\begin{figure}
\centerline{\includegraphics[width=20pc]{figures/fig5.eps}}
...
\begin{figure}
\centerline{\includegraphics[width=12pc]{figures/fig19.eps}}
...
\begin{figure}
\centerline{\includegraphics[width=25pc]{figures/fig8.eps}}
...
\begin{figure}
\centerline{\includegraphics[width=15pc]{figures/fig9.eps}}
...
\begin{figure}
\centerline{\includegraphics[width=32pc]{figures/fig10.eps}}
\caption{Effect of heuristic for finding optimal solution}
\label{fig10}
\end{figure}

\begin{figure}
\centerline{\includegraphics[width=32pc]{figures/fig11.eps}}
...
\begin{figure}
\centerline{\includegraphics[width=35pc]{figures/fig12.eps}}
\vspace*{-8mm}
...
\begin{figure}
\centerline{\includegraphics[width=20pc]{figures/fig18.eps}}
...
\begin{figure}
\centerline{\includegraphics[width=22pc]{figures/fig6.eps}}
...
\begin{figure}
\centerline{\includegraphics[width=18pc]{figures/fig7.eps}}
...
\begin{figure}
\centerline{\includegraphics[width=20pc]{figures/fig13.eps}}
...
\begin{figure}
\centerline{\includegraphics[width=11pc]{figures/fig14.eps}}
...
\begin{figure}
\centerline{\includegraphics[width=18pc]{figures/fig15.eps}}
...
\begin{figure}
\centerline{\includegraphics[width=18pc]{figures/fig16.eps}}
...
\begin{figure}
\centerline{\includegraphics[width=20pc]{figures/fig17.eps}}
