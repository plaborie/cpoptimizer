...
\typeout{IJCAI-05 Instructions for Authors}

% This is the instructions for authors for IJCAI-05.
\documentclass{article}
% The file ijcai05.sty is the style file for IJCAI-05. 
\usepackage{ijcai05}
...
\title{IJCAI--05 Formatting Instructions\thanks{The support of IJCAI, Inc. is acknowledged.}}
\author{Kurt Steinkraus \\
Massachusetts Institute of Technology \\
Computer Science and Artificial Intelligence Laboratory \\
32 Vassar St. Room 32-G585, Cambridge, MA 02139 \\
kurtas@csail.mit.edu}
...
\begin{abstract}
  The {\it IJCAI--05 Proceedings} will be printed from electronic
...
before arriving at its current form.

\appendix

\section{\LaTeX{} and Word Style Files}\label{stylefiles}

The \LaTeX{} and Word style files are available on the IJCAI--05
website, {\tt http://www.ijcai-05.org/}.
These style files implement the formatting instructions in this
document.

The \LaTeX{} files are {\tt ijcai05.sty} and {\tt ijcai05.tex}, and
the Bib\TeX{} files are {\tt named.bst} and {\tt ijcai05.bib}. The
\LaTeX{} style file is for version 2e of \LaTeX{}, and the Bib\TeX{}
style file is for version 0.99c of Bib\TeX{} ({\em not} version
0.98i). The {\tt ijcai05.sty} file is the same as the {\tt
ijcai03-final.sty} file used for IJCAI--03.

The Microsoft Word style file consists of a single template file, {\tt
ijcai05.dot}. This template has changed slightly from that used for
IJCAI--03.

These Microsoft Word and \LaTeX{} files contain the source of the
present document and may serve as a formatting sample.  Note that the
required document layout is the same as for IJCAI'03.

Further information on using these styles for the preparation of
papers for IJCAI--05 can be obtained by contacting {\tt
pcchair05@ijcai.org}.
