\chaptertitleauthors{Fourth chapter}{Simon Pepping}

This is the fourth chapter.

In this chapter we do not start sections.
...
\end{figure}
    ...
    There are three major divisions\index{major divisions} in a book: 
...
far as appearance\index{appearance} goes is that in the front matter the folios\index{folio} are 
...
page is to protect the main title page.
    ...
    The first verso page, the back of the half-title page\index{half-title page}, may contain the 
series title, if the book is one in a series, a list of contributors\index{list of contributors}, 
a frontispiece\index{frontispiece}, or may be blank. The series title may instead be put on the 
...
any event the style\index{style} of this page should give an indication of the style
used in the main body of the work.

    The verso of the title page is the copyright page\index{copyright page}.
This contains the copyright notice\index{copyright notice}, the publishing/printing history, 
...
on a recto page, with the following verso page blank.
    ...
    Use a \verb|\clearpage| command and the end of the last chapter
    before the appendices, in order to get the running headline on the
    last page right.
