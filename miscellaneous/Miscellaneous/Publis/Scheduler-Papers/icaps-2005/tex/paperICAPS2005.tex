% Paper submitted to ICAPS'05. Submission deadline is November 15th 2004. Camera-ready copy due the 9th of March 2005

\documentclass[letterpaper]{article}

\usepackage[pdftex]{graphicx} % instructions for generating the pdf file.
\usepackage{graphicx} % instructions for generating the ps file.
...
\title{Randomized Large Neighborhood Search for Cumulative Scheduling}

\author{Daniel Godard \and Philippe Laborie \and Wim Nuijten \\ ILOG
S.~A.\\ 9, rue de Verdun - B.~P.~85\\ 94253 Gentilly Cedex, France\\
\{dgodard,plaborie,wnuijten\}@ilog.fr}
...
This paper presents a Large Neighborhood Search (LNS) approach based
